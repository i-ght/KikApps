...
{
    internal class MetricsAppOpened
    {
        ...
        [JsonProperty("eventData:Has Unseen New Chat")]
        public bool EventDataHasUnseenNewChat { get; set; }
        ...
        [JsonProperty("eventData:Cold Start")]
        public bool EventDataColdStart { get; set; }
    }
}
